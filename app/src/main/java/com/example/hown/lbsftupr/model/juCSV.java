...
public class juCSV implements Parcelable {
    private String hari;
    ...
    public juCSV(String kodeMK, String hari, String dosen_koordinator, String jam, String lokasi, String matakuliah) {
        super();
        this.hari = hari;
    ...
    public static final Creator<juCSV> CREATOR = new Creator<juCSV>() {
        @Override
        public juCSV createFromParcel(Parcel in) {
            return new juCSV(in);
        }

        @Override
        public juCSV[] newArray(int size) {
            return new juCSV[size];
        }
    };
