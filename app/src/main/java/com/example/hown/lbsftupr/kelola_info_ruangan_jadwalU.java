...
public class kelola_info_ruangan_jadwalU extends AppCompatActivity {

    public DatabaseReference databaseItem1, databaseItem2, db3, db4;
    public Spinner ed1, ed2;
    public Button b1, b2, b3, b4, b5;

    private static final String TAG = kelola_info_ruangan_jadwalU.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelola_info_ruangan_jadwal_u);
        Intent i = getIntent();
        Bundle b = i.getExtras();
        ed1 = (Spinner) findViewById(R.id.ruanganUr);
        //ed2 = (Spinner) findViewById(R.id.doseninfo);

        b1 = (Button) findViewById(R.id.addBtnUr);
        b2 = (Button) findViewById(R.id.refreshUr);
        b4 = (Button) findViewById(R.id.removebtnUr);

        final String jadwall = (String) b.get("jadwal");

        databaseItem1 = FirebaseDatabase.getInstance().getReference().child("jadwalU").child(jadwall).child("ruangan");
        ...
        databaseItem2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot2 : dataSnapshot.getChildren()){
                    ...
                    ((Custominforuanganjadwalu) (((ListView) findViewById(R.id.listruanganjadwalUr)).getAdapter())).notifyDataSetChanged();

                    ed1
                            .setAdapter(new ArrayAdapter<String>(kelola_info_ruangan_jadwalU.this,
        ...
        //adapter isian
        ((ListView)findViewById(R.id.listruanganjadwalUr)).
                setAdapter(new Custominforuanganjadwalu(idruangans, this));
        ((ListView)findViewById(R.id.listruanganjadwalUr)).setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                q1.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        remPerson(key1[0]);
                        Toast.makeText(kelola_info_ruangan_jadwalU.this, "Berhasil dihapus",
        ...
        ((ListView)findViewById(R.id.listruanganjadwalUr)).setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                TextView t1 = (TextView) view.findViewById(R.id.idruanganUr);
                //TextView t3 = (TextView) view.findViewById(R.id.dsn_koorlistinfo);
                String text1 = t1.getText().toString();
                //String text3 = t3.getText().toString();
    ...
    private void addPerson(final String key1){
        ...
        dR2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    Toast.makeText(kelola_info_ruangan_jadwalU.this, "Data sudah ada",
                            Toast.LENGTH_SHORT).show();
                } else
                {
                    ...
                    Toast.makeText(kelola_info_ruangan_jadwalU.this, "Berhasil ditambahkan",
                            Toast.LENGTH_SHORT).show();
                }
            }
