...
import com.example.hown.lbsftupr.annotation.CSVAnnotation.CSVSetter;
...
public class CSVReader {
	...
	public static <T> List<JadwalCSV> readFile(Context context, File file, Class<T> cl) throws IOException, IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
		
		List<JadwalCSV> list = new ArrayList<JadwalCSV>();
