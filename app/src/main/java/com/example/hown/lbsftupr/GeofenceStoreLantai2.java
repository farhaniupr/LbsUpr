...
public class GeofenceStoreLantai2 implements ConnectionCallbacks,
    ...
    public GeofenceStoreLantai2(Context context, ArrayList<Geofence> geofences) {
        mContext = context;
        mGeofences = new ArrayList<Geofence>(geofences);

        Log.v(TAG, "Lantai 2 Geofence Store Connect" + mGeofences);
        mPendingIntent = null;
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        Log.v(TAG, "Lantai 2 Connect");



        Log.d(TAG, "Lantai 2 Geofence Store : " + mGeofences);
        mGeofencingRequest = new GeofencingRequest.Builder().addGeofences(
                mGeofences).build();


        //Log.d(TAG, "Lantai 2: " + mGeofences);
    ...
    private PendingIntent createRequestPendingIntent() {
        if (mPendingIntent == null) {
            ...
            Intent intent = new Intent(mContext, GeofenceL2.class);
