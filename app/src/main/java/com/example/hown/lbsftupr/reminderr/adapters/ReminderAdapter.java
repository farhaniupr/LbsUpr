package com.example.hown.lbsftupr.reminderr.adapters;
...
public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        //@BindView(R.id.spinner_content) TextView sc;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        /**viewHolder.sc.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String selectedName = parent.getItemAtPosition(position).toString();
                reminderList.get(position).getContent();
            }
        });*/
