...
import com.example.hown.lbsftupr.reminderr.receivers.SnoozeReceiver;
...
public class ViewActivity extends AppCompatActivity {
    ...
    //@BindView(R.id.spinner_content) Spinner contentText;
    ...
    public void actionMarkAsDone() {
        ...
        if (reminder.getNumberShown() + 1 != reminder.getNumberToShow() || Boolean.parseBoolean(reminder.getForeverState())) {
            AlarmUtil.setNextAlarm(ViewActivity.this, reminder, database);
        } else {
