...
public class Lantai1 extends FragmentActivity implements OnCameraChangeListener, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ResultCallback<Status>, GoogleMap.OnInfoWindowClickListener, GoogleMap.OnMarkerClickListener {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mGeofenceStore = new GeofenceStoreLantai2(Lantai1.this, mGeofences);
                }
                    ...
                    databaseItem2.child(key).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                               ...
                               /** Intent i = new Intent(Lantai1.this, Tampillaninfomap.class);
                                i.putExtra("title", marker.getTitle());
                                //i.putExtra("matakuliah", matakuliahs);
                                //i.putExtra("dosen", dsn_koors);
                                i.putExtra("lantai", "l1");
                                startActivity(i);
                                finish();
    ...
    private void retrieveFileFromUrl() {
        new DownloadKmlFile("https://firebasestorage.googleapis.com/v0/b/lbs-teknik-upr.appspot.com/o/itv9.kml?alt=media&token=e2b7f181-9ef1-4794-9359-ccc72c1f5bb5").execute();
    }
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        final Query query = databaseItem.orderByChild("altitude").equalTo("10");
    ...
    private void markerLocation(final GoogleMap map1, ArrayList<Lantai> rng) {
        ...
        for (Lantai ruang : rng1) {
            ...
            Marker m = map1.addMarker(new MarkerOptions()
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks(Lantai1.this)
    ...
    private void refreshLocation(Location location) {
        ...
        /*if (altitude > 50.0) {
            Intent intent = new Intent (Lantai1.this, pilihlantai.class);
            startActivity (intent);
            finish();
       } else
        if (altitude < 50.0){
            Toast.makeText(Lantai1.this, "Anda berada di lantai dasar", Toast.LENGTH_SHORT).show();
        }**/
