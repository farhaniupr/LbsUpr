package com.example.hown.lbsftupr.reminderr.utils;
...
import com.example.hown.lbsftupr.reminderr.receivers.DismissReceiver;
import com.example.hown.lbsftupr.reminderr.receivers.NagReceiver;
import com.example.hown.lbsftupr.reminderr.receivers.SnoozeActionReceiver;
import com.example.hown.lbsftupr.reminderr.activities.ViewActivity;
...
public class NotificationUtil {
    ...
    public static void createNotification(Context context, Reminder reminder) {
        ...
        PendingIntent pending = PendingIntent.getActivity(context, reminder.getId(), viewIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_ONE_SHOT);
        ...
        PendingIntent pendingSnooze = PendingIntent.getBroadcast(context, reminder.getId(), snoozeIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_ONE_SHOT);
        ...
        if (sharedPreferences.getBoolean("checkBoxNagging", false)) {
            ...
            PendingIntent pendingDismiss = PendingIntent.getBroadcast(context, reminder.getId(), swipeIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_ONE_SHOT);
        ...
        if (sharedPreferences.getBoolean("checkBoxMarkAsDone", false)) {
            ...
            PendingIntent pendingIntent = PendingIntent.getBroadcast(context, reminder.getId(), intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_ONE_SHOT);
